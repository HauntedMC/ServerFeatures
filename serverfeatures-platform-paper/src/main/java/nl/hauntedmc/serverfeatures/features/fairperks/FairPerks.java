...
public final class FairPerks extends BukkitBaseFeature<Meta>
    ...
    public void initialize() {
        ...
        if (settings.godMacro().enabled()) {
            getLifecycleManager().getCommandManager().registerBrigadierCommand(new GodMacroCommand(this));
            getLifecycleManager().getListenerManager().registerListener(new GodMacroListener(this));
        }
        getLifecycleManager().getCommandManager().registerBrigadierCommand(new FairPerksCommand(this));

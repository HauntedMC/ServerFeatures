...
public class VotifierVoteListener implements Listener {
    ...
    public void onVotifierEvent(VotifierEvent event) {
        ...
        IncomingVote received = new IncomingVote(
                v.getServiceName(),
                v.getUsername(),
                v.getAddress(),
                ts
        ...
        IncomingVote vote = new IncomingVote(
                ...
                received.address(),
                received.timestamp(),
                VoteDispatchTracker.currentProcessingKey().orElse(received.processingKey())
        );
        VoteDispatchTracker.trackCurrent(feature.getVoteHandler().handleVote(vote));
    }
}

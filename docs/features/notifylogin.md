...
7. Join and quit while persisted vanished; neither message may be public.
8. Join visible, enter vanish and quit; the quit message must be suppressed.
9. Test multiple recipient languages while the subject nickname remains correct.
10. Reload during a pending join and confirm no stale announcement is delivered.
11. Introduce an invalid message value or priority and verify a clear warning plus fail-closed behavior.

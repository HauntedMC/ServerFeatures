 ...
 */
public final class ActionbarBrigadierCommand implements BrigadierCommand {
    ...
    public @NotNull String name() {
        return "actionbarbrig";
    } // distinct root while testing

    @Override
    public String description() {
        return "Actionbar (Brigadier test)";
    }

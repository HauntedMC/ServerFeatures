...
public class TitleHandler {
    ...
    public void sendJoinTitle(Player player) {
        Component title = feature.getLocalizationHandler().getMessage("titles.join_title", player);
        String serverName = (String) feature.getConfigHandler().getSetting("server");
        Component subtitle = feature.getLocalizationHandler().getMessage("titles.join_subtitle", player, Map.of("server", serverName));

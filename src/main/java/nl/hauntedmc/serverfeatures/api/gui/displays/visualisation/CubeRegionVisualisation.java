package nl.hauntedmc.serverfeatures.api.gui.displays.visualisation;
...
import nl.hauntedmc.serverfeatures.api.gui.displays.handle.DisplayVisualHandle;
import nl.hauntedmc.serverfeatures.api.gui.displays.options.VisualOptions;
import nl.hauntedmc.serverfeatures.api.gui.displays.shape.RegionShape;
import org.bukkit.*;
 ...
 */
public final class CubeRegionVisualisation implements Visualisation {

    private final Plugin plugin;

    public CubeRegionVisualisation(Plugin plugin) {
        this.plugin = plugin;
    }

...
import nl.hauntedmc.serverfeatures.api.ui.hud.actionbar.ActionBarService;
...
public final class NoopActionBarService implements ActionBarService {
    public static final NoopActionBarService INSTANCE = new NoopActionBarService();
    private static final ActionBarCycleHandle NOOP_HANDLE = new ActionBarCycleHandle() {
        @Override public boolean isActive() { return false; }
        @Override public void cancel() { /* no-op */ }
    };
    private NoopActionBarService() {}
